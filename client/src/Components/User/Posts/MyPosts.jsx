...
const MyPosts = () => {
  ...
  return (
    <div className="py-20">
      ...
      <div className="text-left px-10 sm:px-16 text-3xl flex items-center space-x-5"><BookOutlined className="text-gray-500" /><span className="text-gray-500">My Blogs<hr className="outline-none border-none mt-1 py-[3px] rounded-2xl" /></span></div>
